...
DROP TABLE IF EXISTS census_tracts_2010_diversity;

CREATE TABLE census_tracts_2010_diversity ( 
...
\COPY census_tracts_2010_diversity FROM 'E:\git\SOLAP\datasets\census_tracts_2010_diversity.csv' WITH CSV HEADER ENCODING 'LATIN-1';

ALTER TABLE census_tracts_2010_diversity ADD gid SERIAL;
